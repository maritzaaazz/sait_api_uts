...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 24, 2024 at 12:58 PM
...
(1, 'sv_001', 'svpl_001', 88),
(2, 'sv_001', 'svpl_002', 100),
(3, 'sv_001', 'svpl_003', 88),
(4, 'sv_002', 'svpl_001', 98),
(7, 'sv_002', 'svpl_003', 90);
...
ALTER TABLE `perkuliahan`
  ...
  ADD KEY `FK mahasiswa` (`nim`),
  ADD KEY `FK matakuliah` (`kode_mk`);
...
--
ALTER TABLE `perkuliahan`
  ADD CONSTRAINT `FK mahasiswa` FOREIGN KEY (`nim`) REFERENCES `mahasiswa` (`nim`),
  ADD CONSTRAINT `FK matakuliah` FOREIGN KEY (`kode_mk`) REFERENCES `matakuliah` (`kode_mk`);
COMMIT;
